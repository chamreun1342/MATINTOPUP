    ...
    <div class="container">
        ...
        <div class="uc-grid">
            <div class="uc-item" onclick="selectUC(this, '60 UC', 0.99)">
                <img src="Screenshot_20260321-005550_.jpg" alt="UC">
                <br>
            ...
            <div class="uc-item" onclick="selectUC(this, '325 UC', 4.49)">
                <img src="Screenshot_20260321-005436_.jpg" alt="UC">
                <br>
            ...
            <div class="uc-item" onclick="selectUC(this, '660 UC', 9.99)">
                <img src="Screenshot_20260321-005529_.jpg" alt="UC">
                <br>
            ...
            <div class="uc-item" onclick="selectUC(this, '3850 UC', 45.49)">
                <img src="Screenshot_20260321-005504_.jpg" alt="UC">
                <br>
...
<script>
    ...
    function startPayment() {
        ...
        // --- កន្លែងសម្រាប់បង Paste Link ABA តាមតម្លៃនីមួយៗ (Fixed Amount Link) ---
        let aba_link = "";

        if (finalPrice === 0.99) {
            aba_link = "https://link.payway.com.kh/ABAPAYzO426212Q"; // ឧទាហរណ៍ ០.៩៩
        } else if (finalPrice === 4.49 || finalPrice === 4.99) {
            aba_link = "https://link.payway.com.kh/ABAPAY4R426213H";
        } else if (finalPrice === 9.99) {
            aba_link = "https://link.payway.com.kh/ABAPAY6x4262144";
        } else if (finalPrice === 24.99) {
            aba_link = "https://link.payway.com.kh/ABAPAYZX426215x";
        } else if (finalPrice === 45.49) {
            aba_link = "https://link.payway.com.kh/ABAPAYAA426216o";
        } else if (finalPrice === 90.49) {
            aba_link = "https://link.payway.com.kh/ABAPAY6j426217o";
        } else if (finalPrice === 180.49) {
            aba_link = "https://link.payway.com.kh/ABAPAYQL426218W";
        } else if (finalPrice === 3.49) {
            aba_link = "https://link.payway.com.kh/ABAPAYDB426219H";
        } else {
            aba_link = "https://link.payway.com.kh/ABAPAYNm426208D";
        }
        ...
        .then(() => {
            // បាញ់ទៅ Link ABA ដែលមានតម្លៃអូតូស្រាប់ រួមជាមួយការដាក់ Remark ជាលេខ ID
            window.location.href = aba_link + "?remark=" + encodeURIComponent(gameName + "_" + id); 
        })
        .catch(() => {
            window.location.href = aba_link;
        });
    }
