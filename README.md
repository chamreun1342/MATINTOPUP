    ...
    <div class="container">
        ...
        <div class="card-box">
            ...
            <div style="display:flex; gap:10px;">
                <input type="number" class="id-input" placeholder="បញ្ចូលលេខ ID" id="u-id" style="flex:2;">
                <input type="number" class="id-input" placeholder="Zone" id="u-zone" style="flex:1; display:none;">
            </div>
        ...
        <label style="font-size: 11px; color: var(--text-gray); display: flex; align-items: center; gap: 8px; margin-top: 15px; cursor: pointer; padding: 0 5px;">
            ...
            ខ្ញុំបានពិនិត្យលេខ ID ត្រឹមត្រូវ ១០០% ហើយ
        </label>
    </div>
</div>
...
<div class="receipt-overlay" id="receipt-modal">
    <div class="receipt-card" id="receipt-to-print">
        <div class="receipt-header">
            <img src="logo.png" style="width:50px; border-radius:50%; border:1px solid #ddd;"><br>
        ...
        <div class="receipt-row"><span>ID ភ្ញៀវ:</span> <b id="r-id">...</b></div>
...
<script>
    ...
    // ១. មុខងារឆែកឈ្មោះ (Check ID) - បន្ថែមថ្មី
    ...
    // ២. មុខងារបង់ប្រាក់ និងរង់ចាំឆែកលុយ (Auto Polling) - បន្ថែមថ្មី
    function startPayment() {
        ...
        // បង្ហាញផ្ទាំងរង់ចាំផ្ទៀងផ្ទាត់ (Polling)
        ...
        const checkPaidInterval = setInterval(() => {
            ...
            // បើបងមាន API ឆែកលុយ បងត្រូវហៅនៅទីនេះ
            // បើជោគជ័យ ឱ្យវាលោតវិក័យប័ត្រ (Receipt)
            
            // សាកល្បង៖ បន្ទាប់ពី ១០ វិនាទី ឱ្យវាលោតវិក័យប័ត្រអូតូ
            if (timeLeft === 50) {
    ...
    // ៣. មុខងារវិក័យប័ត្រ (Show Receipt) - បន្ថែមថ្មី
